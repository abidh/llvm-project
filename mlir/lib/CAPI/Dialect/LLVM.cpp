...
MlirAttribute mlirLLVMDICompositeTypeAttrGet(
    ...
    MlirAttribute location, MlirAttribute rank,
    MlirAttribute allocated, MlirAttribute associated) {
  ...
  return wrap(DICompositeTypeAttr::get(
      ...
      cast<DIExpressionAttr>(unwrap(location)),cast<DIExpressionAttr>(unwrap(rank)),
      cast<DIExpressionAttr>(unwrap(allocated)),cast<DIExpressionAttr>(unwrap(associated))));
}
