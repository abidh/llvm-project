...
#g_var = #llvm.di_global_variable<scope = #cu, name = "arr",
  linkageName = "_QFEarr", file = #di_file, line = 4,
  type = #array_ty, isDefined = true>
#g_var_expr = #llvm.di_global_variable_expression<var = #g_var>
#sp = #llvm.di_subprogram<recId = distinct[1]<>, id = distinct[2]<>,
  compileUnit = #cu, scope = #di_file, name = "test", linkageName = "test",
  file = #di_file, line = 1, scopeLine = 1,
  subprogramFlags = "Definition|MainSubprogram", type = #sp_ty>
#var_arr = #llvm.di_local_variable<scope = #sp,
  name = "arr", file = #di_file, line = 4, type = #array_ty>
#var_i = #llvm.di_local_variable<scope = #sp,
  name = "i", file = #di_file, line = 13, type = #int_ty>
#var_x = #llvm.di_local_variable<scope = #sp,
 name = "x", file = #di_file, line = 12, type = #real_ty>
