...
#cu = #llvm.di_compile_unit<id = distinct[0]<>, sourceLanguage = DW_LANG_C,
 file = #file, isOptimized = false, emissionKind = None>
#sp = #llvm.di_subprogram<compileUnit = #cu, scope = #file, name = "string_ty",
...
module attributes {} {
  llvm.func @string_ty(%arg0: !llvm.ptr loc(unknown)) {
