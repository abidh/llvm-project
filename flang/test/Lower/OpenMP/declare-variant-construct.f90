...
! selectors and ranking between multiple applicable variants.  These mirror
! the construct-trait scenarios already exercised by metadirective-construct.f90
! to confirm the shared OMPContext matching rules apply to declare variant.

!===----------------------------------------------------------------------===!
! Combined construct directive selector: construct={target teams}
!===----------------------------------------------------------------------===!
...
!===----------------------------------------------------------------------===!
! Multi-trait construct set requiring nesting: construct={target, parallel}
!===----------------------------------------------------------------------===!
...
!===----------------------------------------------------------------------===!
! Ranking by specificity between multiple applicable variants
!===----------------------------------------------------------------------===!
...
!===----------------------------------------------------------------------===!
! Ranking by explicit score between two applicable variants
!===----------------------------------------------------------------------===!
